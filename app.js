document.addEventListener('alpine:init', () => {
    Alpine.store('dashboard', {
        ...
        updateChart(data) {
            ...
            this.investmentTotal = accumulated.length ? accumulated[accumulated.length - 1] : 0;
        ...
        // Rotación
        nextPage() {
            this.currentPage = (this.currentPage + 1) >= this.totalPages ? 0 : this.currentPage + 1;
            this.progress = 0;
        ...
        async fetchData() {
            try {
                ...
                if (data.investment_chart && JSON.stringify(data.investment_chart) !== JSON.stringify(this.investment)) {
